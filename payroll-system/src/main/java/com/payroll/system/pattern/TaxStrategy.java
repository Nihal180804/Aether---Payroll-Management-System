...
/** Tax calculation contract for each supported country or regime. */
public interface TaxStrategy {

    double calculateMonthlyTax(Employee emp, double annualGrossIncome);

    /** Tax rules for the India old regime. */
    ...
    /** Tax rules for the India new regime. */
    ...
    /** Tax rules for US federal payroll. */
    ...
    /** Tax rules for Singapore payroll. */
