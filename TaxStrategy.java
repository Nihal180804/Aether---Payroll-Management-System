...
public interface TaxStrategy {
     ...
     *
     * @param emp               The employee (used for declared investments, filing
     *                          status, etc.)
    ...
    class IndiaOldRegime implements TaxStrategy {
        ...
        public double calculateMonthlyTax(Employee emp, double annualGrossIncome) {
            // TODO Step 1: Compute taxableIncome (subtract standard deduction +
            // declaredInvestments)
     ...
     * ─────────────────────────────────────────────────────────────────────────
     * New Regime: higher standard deduction (₹75,000), NO 80C/investment
     * deductions.
     *
    ...
    class IndiaNewRegime implements TaxStrategy {
        ...
        @Override
        public double calculateMonthlyTax(Employee emp, double annualGrossIncome) {
            // TODO Step 1: taxableIncome = annualGrossIncome - 75,000 (no investment
            // deduction!)
     ...
     *
     * HINT: Check filing status with:
     * "MARRIED".equalsIgnoreCase(emp.getFilingStatus())
     * ─────────────────────────────────────────────────────────────────────────
     */
     ...
     * > S$320K → 22%
     *
     * HINT: No filing status needed. Just apply slabs to annualGrossIncome
     * directly.
     * ─────────────────────────────────────────────────────────────────────────
     */
